...
from src.alignment import DPOConfig, ScriptArguments, get_dataset, get_model, get_tokenizer, apply_chat_template
from trl import DPOTrainer, ModelConfig, TrlParser, get_peft_config

import os
os.environ['HF_HOME'] = os.environ['WORK'] + '/.cache/huggingface'
DATA_PATH = os.environ['WORK']+ '/attributionBench_augmentedselectErrortypesbalanced' #attributionBench_augmented_gen_from_hardpositives_only'  ###/attributionBench_lfqa_expertqa_dpo'
...
def main(script_args, training_args, model_args):
    ...
    dataset = dataset.map(
        ...
        num_proc=training_args.dataset_num_proc, #4 # Use multiple processes for faster mapping 
